...
const CreditApplicationSidebar: React.FC<CreditApplicationSidebarProps> = ({ applicationId }) => {
  ...
  const menuItems = [
    ...
    },
    {
      id: 'asset-ledger',
      name: 'Asset Ledger',
      path: `${basePathWithId}/asset-ledger`,
      icon: icons.assetLedger,
      visibleTo: ['lender', 'broker', 'admin'],
    },
    {
      id: 'vendor-payment-kyb',
      name: 'Vendor Payment & KYB',
      path: `${basePathWithId}/vendor-payment-kyb`,
      icon: icons.vendorPaymentKYB,
      visibleTo: ['lender', 'broker', 'admin'],
    },
    {
      id: 'broker-kyb-payment',
      name: 'Broker KYB & Payment',
      path: `${basePathWithId}/broker-kyb-payment`,
      icon: icons.brokerKYBPayment,
    ...
    },
    {
      ...
      path: `${basePathWithId}/broker-commission-split`,
      icon: icons.brokerCommissionSplit,
      visibleTo: ['lender', 'broker', 'admin'],
    },
    {
      id: 'lender-commission-split',
      name: 'Lender Commission Split',
      path: `${basePathWithId}/lender-commission-split`,
      icon: icons.lenderCommissionSplit,
      visibleTo: ['lender', 'admin'],
    },
    {
