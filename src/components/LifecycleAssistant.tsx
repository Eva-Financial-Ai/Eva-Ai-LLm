    ...
    <div className="fixed bottom-0 right-0 w-full sm:w-96 bg-white shadow-lg rounded-t-lg border border-gray-200 z-40">
      ...
      <div className="max-h-[400px] overflow-y-auto">
        ...
        <div className="p-4 border-b">
          ...
          <div className="bg-green-50 p-3 rounded-lg mb-3">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-500">Last 3 months of business banking statements</p>
              </div>
              <span className="text-xs text-green-600 font-medium">Received</span>
            </div>
          </div>
          ...
          <div className="bg-green-50 p-3 rounded-lg mb-3">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-500">Last 2 years of business tax returns (including all schedules)</p>
              </div>
              <span className="text-xs text-green-600 font-medium">Received</span>
            </div>
          </div>
          ...
          {documents.filter(doc => !['financial', 'bank', 'tax'].includes(doc.type)).map(doc => (
            <div 
              key={doc.id} 
              className={`${
                doc.status === 'received' ? 'bg-green-50' : 
                doc.status === 'pending' ? 'bg-yellow-50' : 'bg-gray-50'
              } p-3 rounded-lg mb-3`}
            >
              <div className="flex justify-between items-center">
                <div>
                ...
                <span 
                  className={`text-xs font-medium ${
                    doc.status === 'received' ? 'text-green-600' : 
        ...
        <div className="p-4 border-t">
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary-600 mt-0.5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
      ...
      {showCreditApplication && (
        <CreditApplicationBlockchain
          ...
          initialApplication={
            applicationMode === 'create' ? undefined : {
