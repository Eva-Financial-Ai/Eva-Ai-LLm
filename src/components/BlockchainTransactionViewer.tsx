    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl relative overflow-hidden">
        ...
        <div className="bg-primary-600 text-white p-4 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="rounded-full p-1 hover:bg-primary-500"
          >
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div>
                      ...
                      <p className="text-sm capitalize">{transaction.data.applicationType.replace('_', ' ')}</p>
                    </div>
                    <div>
        ...
        <div className="border-t p-4 bg-gray-50 flex justify-between items-center">
          <p className="text-xs text-gray-500">
            Powered by EVA Blockchain Network
          </p>
          <a
            href="#"
