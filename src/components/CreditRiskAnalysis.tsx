...
const CreditRiskAnalysis: React.FC<CreditRiskAnalysisProps> = ({ isOpen, onClose, applicantId }) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-4">
                      <div className={`inline-flex rounded-full px-3 py-1 text-sm font-semibold ${getRiskColorClasses(risk)}`}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mb-1">
                    <div 
                      className={`h-2.5 rounded-full ${
                        creditScore && creditScore >= 740 ? 'bg-green-500' :
                        creditScore && creditScore >= 670 ? 'bg-yellow-500' :
                        creditScore && creditScore >= 580 ? 'bg-orange-500' :
                        'bg-red-500'
                      }`}
                      style={{ width: `${creditScore ? Math.min(Math.max((creditScore / 850) * 100, 10), 100) : 0}%` }}
                    ></div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-sm font-medium text-gray-700">Cash Flow Sustainability</span>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-sm font-medium text-gray-700">Debt Service Coverage</span>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        <span className="text-sm text-gray-700">Consistent monthly revenue growth (4.2% avg)</span>
                      </li>
                      <li className="flex items-center">
                        <svg className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-sm text-gray-700">No payment defaults on existing obligations</span>
                      </li>
                      <li className="flex items-center">
                        <svg className="h-5 w-5 text-yellow-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                        <span className="text-sm text-gray-700">Seasonal cash flow variations requiring attention</span>
                      </li>
                    </ul>
                  </div>
                </div>
