...
const LienUCCManagement: React.FC<LienUCCManagementProps> = ({
  ...
  const [modalMode, setModalMode] = useState<'create' | 'edit' | 'view' | 'release' | 'subordinate'>('create');
  ...
  const mockLiens: Lien[] = [
    {
      ...
      collateralDescription: 'All business assets including equipment, inventory, and accounts receivable',
      amount: 250000,
      status: 'Active',
  ...
  const renderModal = () => {
    ...
    const isReadOnly = modalMode === 'view' || modalMode === 'release' || modalMode === 'subordinate';
    ...
    const currentLien = selectedLien || {
      ...
      expirationDate: new Date(new Date().setFullYear(new Date().getFullYear() + 5)).toISOString().split('T')[0],
      securedParty: '',
      debtor: businessName || '',
                          ...
                          <div className="flex">
                            ...
                            <div className="ml-3">
                              ...
                              <div className="mt-2 text-sm text-yellow-700">
                                <p>
                                  This action will mark this filing as released and create an immutable blockchain record. This action cannot be undone.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="bg-yellow-50 p-4 rounded-md">
                          <div className="flex">
                            ...
                            <div className="ml-3">
                              ...
                              <div className="mt-2 text-sm text-yellow-700">
                                <p>
                                  This will record a subordination agreement for this lien, giving priority to another secured party. Please upload a signed subordination agreement to proceed.
                                </p>
                              </div>
                            </div>
                          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Filing/Details</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Secured Party</th>
                  ...
                  <tr key={lien.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        lien.status === 'Active' ? 'bg-green-100 text-green-800' :
                        lien.status === 'Pending' ? 'bg-yellow-100 text-yellow-800' :
                        lien.status === 'Released' ? 'bg-gray-100 text-gray-800' :
                        lien.status === 'Subordinated' ? 'bg-blue-100 text-blue-800' :
