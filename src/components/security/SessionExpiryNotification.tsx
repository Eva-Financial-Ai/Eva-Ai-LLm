          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                <strong>Security warning:</strong> Your quantum-resistant cryptography session will
                expire in {sessionTimeRemaining} seconds.
              </p>
              <div className="mt-2">
                <button
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-red-700">
                <strong>Security alert:</strong> Your quantum-resistant cryptography session has
                expired. For your security, please re-authenticate.
              </p>
              <div className="mt-2">
                <button
