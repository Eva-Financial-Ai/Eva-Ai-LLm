...
const TransactionDocumentVault: React.FC<TransactionDocumentVaultProps> = ({
  ...
  const mapTransactionStatus = (status: string): 'draft' | 'in_progress' | 'funded' | 'completed' => {
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-indigo-600 px-6 py-4">
            ...
            <p className="text-indigo-100 mt-1">
              AI-recommended document retention analysis
            </p>
          </div>
          ...
          <div className="p-6">
            {aiRecommendation ? (
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700">Recommended Retention Period:</h4>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">
                        ...
                        {document.lastModified ? new Date(document.lastModified).toLocaleDateString() : 'Unknown date'}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    {vaultState.lockedDocuments[document.id] ? (
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                        <svg className="-ml-0.5 mr-1.5 h-3 w-3 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    >
                      <svg className="-ml-0.5 mr-1.5 h-4 w-4 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                      AI Analysis
                    </button>
