...
const FilelockBlockchainService: React.FC<FilelockBlockchainServiceProps> = ({ file, onComplete, onCancel }) => {
  ...
  const processOCR = async () => {
    ...
    setVerificationDetails(prev => ({
      ...prev,
      ocrText: "Document content extracted and analyzed. Content verified for authenticity and consistency."
    }));
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="bg-primary-600 px-6 py-4">
        ...
        <p className="text-primary-100 mt-1">Verify, secure, and create an immutable record of your document</p>
      </div>
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {file.type.toUpperCase()} • {file.size ? `${Math.round(file.size / 1024)} KB` : 'Unknown size'} • Last modified: {new Date(file.lastModified).toLocaleDateString()}
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg border p-4 mb-6">
          ...
          <ul className="space-y-2">
            <li className="flex items-start">
              ...
              <span className="text-sm text-gray-700">Immutable document verification with blockchain technology</span>
            </li>
            <li className="flex items-start">
              <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm text-gray-700">Advanced OCR extraction and content verification</span>
            </li>
            <li className="flex items-start">
              <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm text-gray-700">Document source and history authentication</span>
            </li>
            <li className="flex items-start">
              <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm text-gray-700">Tamper-proof verification for fraud prevention</span>
            </li>
          </ul>
        </div>
        ...
        {verificationStatus === 'pending' ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm font-medium text-gray-700">DocEasy AI OCR Verification</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm font-medium text-gray-700">Shield Network Ledger Registration</span>
            ...
            <div className="text-center py-4">
              <div className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-primary-700 bg-primary-100">
                <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-primary-700" fill="none" viewBox="0 0 24 24">
          ...
          <div className="text-center py-6 space-y-4">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mt-4 text-left">
              ...
              <p className="text-sm text-purple-600 mt-1">Transaction ID: {verificationDetails.blockchainTxId}</p>
              <p className="text-sm text-purple-600 mt-1">Verification Time: {new Date().toLocaleString()}</p>
            </div>
            ...
            {showAdvancedDetails && (
              <div className="mt-4 space-y-4 text-left">
                ...
                <div className="bg-gray-50 border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700">Source verification confidence: {verificationDetails.sourceConfidence}%</p>
                </div>
