      ...
      <div className="flex items-start">
        ...
        <div className="flex-1">
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">
            {t('pwa.installTitle', 'Install EVA AI App')}
          </h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {t('pwa.installDescription', 'Install EVA AI for faster access and improved offline experience.')}
          </p>
        ...
        >
          <span className="sr-only">{t('pwa.closeButton', 'Close')}</span>
