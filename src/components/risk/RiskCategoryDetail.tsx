    ...
    const factors: Record<RiskCategory, RiskFactor[]> = {
      ...
      capacity: [
        {
          ...
          impact: score > 70 ? 'positive' : 'negative',
          description: score > 70 ? 'Healthy debt service coverage' : 'Debt service coverage concerns',
      ...
      conditions: [
        ...
        },
        {
          ...
          description: score > 65 ? 'Stable economic environment' : 'Challenging economic environment',
          value: Math.min(100, Math.max(0, score - 10))
        },
        {
      ...
      character: [
        {
          ...
          impact: score > 80 ? 'positive' : 'neutral',
          description: score > 80 ? 'Extensive industry experience' : 'Moderate industry experience',
          value: Math.min(100, Math.max(0, score + 10))
        },
        {
          id: 'business-history',
        ...
        {riskFactors.map((factor) => (
          <div key={factor.id} className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <div className="flex items-center">
              ...
              <span className={`text-sm font-medium ${getValueColor(factor.value)}`}>{factor.value}</span>
            </div>
          </div>
        ))}
      </div>
