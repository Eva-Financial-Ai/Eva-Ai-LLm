...
const StripeConnectModal: React.FC<StripeConnectModalProps> = ({
  ...
  const [currentStep, setCurrentStep] = useState<'intro' | 'account' | 'verification' | 'connecting' | 'success'>('intro');
        ...
        return (
          <div className="py-4">
            <div className="mb-6 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">Connect your Stripe account</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Connect your existing Stripe account or create a new one with full customization and control
                    </p>
                  </div>
                </div>
              </div>
      ...
      case 'success':
        return (
          <div className="py-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Your {accountType === 'standard' ? 'Standard' : 'Express'} Stripe account has been connected successfully.
            </p>
