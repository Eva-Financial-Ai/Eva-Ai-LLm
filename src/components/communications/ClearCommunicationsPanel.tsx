...
const ClearCommunicationsPanel: React.FC<ClearCommunicationsPanelProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 w-2/3 max-w-lg bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-30 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
    >
      {/* Header */}
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {contact.role}, {extractOrganization(contact.name)}
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-3">
                <div className="p-3 border-l-4 border-primary-500 bg-gray-50 rounded-r-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1 truncate">
                    Regarding document review for Smith Enterprises loan application
                  </p>
                </div>
                <div className="p-3 border-l-4 border-green-500 bg-gray-50 rounded-r-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1 truncate">
                    Discussed financial projections, 15 min call
                  </p>
                </div>
                <div className="p-3 border-l-4 border-blue-500 bg-gray-50 rounded-r-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1 truncate">
                    Contract review session scheduled with Emma Rodriguez
                  </p>
                </div>
              </div>
            </div>
