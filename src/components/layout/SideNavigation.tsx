  ...
  const navigation: NavigationItem[] = [
    {
      ...
      href: '/dashboard',
      icon: (active) => (
        <svg className={`h-5 w-5 ${active ? 'text-primary-600' : 'text-gray-400'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      current: location.pathname === '/portfolio-navigator',
    },
    {
    ...
    },
    {
      ...
      current: location.pathname === '/document-center',
    },
    {
      name: 'Asset Press',
      href: '/asset-press',
