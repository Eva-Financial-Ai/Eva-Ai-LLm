...
const OwnerManager: React.FC<OwnerManagerProps> = ({ 
  ...
  const getOwnerTypeClasses = (type: 'individual' | 'business' | 'trust'): string => {
    switch (type) {
      case 'individual': return 'bg-primary-100 text-primary-800 border-primary-200';
      case 'business': return 'bg-blue-100 text-blue-800 border-blue-200';
      case 'trust': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-500 mb-4">
                      Adding an additional owner is necessary for businesses with multiple owners. Each owner with 20% or more ownership must be included in the application.
                    </p>
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        >
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">Natural person who owns part of the business. Requires personal identification and contact information.</p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">Company, LLC, or corporation that owns part of the business. Requires EIN and primary contact.</p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">Legal entity that holds assets for beneficiaries. Will require personal guarantor information from trustees for credit approval.</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mb-4 border-b border-light-border">
          <nav className="flex flex-wrap -mb-px" aria-label="Owner navigation">
            {owners.map((owner, index) => (
              ...
              >
                <span className={`inline-flex items-center justify-center w-5 h-5 rounded-full mr-2 text-xs ${getOwnerTypeClasses(owner.type)}`}>
                ...
                <span className="ml-1.5 text-xs text-light-text-secondary">{owner.ownershipPercentage}%</span>
              </button>
            ))}
          </nav>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between mb-4 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
        <div className="space-y-1">
          <div>
            ...
            <span className={`font-medium ${totalOwnership > 100 ? 'text-risk-red' : totalOwnership === 100 ? 'text-success-green' : 'text-light-text'}`}>
              {totalOwnership}%
            </span>
            {totalOwnership > 100 && <span className="text-xs text-risk-red ml-2">(Cannot exceed 100%)</span>}
            {totalOwnership < 100 && totalOwnership > 0 && <span className="text-xs text-yellow-500 ml-2">({100 - totalOwnership}% remaining)</span>}
          </div>
        ...
        <button
          ...
          title="Add another owner with 20% or more ownership"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="p-3 bg-white rounded border border-light-border">
            <div className="flex items-center mb-2">
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full mr-2 text-xs bg-primary-100 text-primary-800 border border-primary-200">I</span>
              <span className="font-medium">Individual</span>
            </div>
            <p className="text-xs text-light-text-secondary">
              A natural person who owns part of the business. Requires personal identification and contact information.
            </p>
          </div>
          
          <div className="p-3 bg-white rounded border border-light-border">
            <div className="flex items-center mb-2">
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full mr-2 text-xs bg-blue-100 text-blue-800 border border-blue-200">B</span>
              <span className="font-medium">Business</span>
            </div>
            <p className="text-xs text-light-text-secondary">
              A company, corporation, or LLC that owns part of the business. Requires EIN and primary contact information.
            </p>
          </div>
          
          <div className="p-3 bg-white rounded border border-light-border">
            <div className="flex items-center mb-2">
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full mr-2 text-xs bg-yellow-100 text-yellow-800 border border-yellow-200">T</span>
              <span className="font-medium">Trust</span>
            </div>
            <p className="text-xs text-light-text-secondary">
              A legal entity that holds assets. Will require personal guarantor information from trustees for credit approval.
            </p>
          </div>
        </div>
      </div>
