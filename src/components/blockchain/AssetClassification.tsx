...
export const ASSET_CLASSES: AssetClass[] = [
  {
    ...
    description: 'Highly liquid assets including cash, checking accounts, savings accounts, money market accounts, and short-term CDs.',
  ...
  },
  {
    ...
    description: 'Debt securities issued by government entities at federal, state, or municipal levels.',
  ...
  },
  {
    ...
    depreciationType: 'REITs: Corporate level; Property: 27.5 years residential, 39 years commercial',
  ...
  },
  {
    ...
    depreciationType: 'Not subject to traditional depreciation; values may decrease with volatility',
    appreciationPotential: 'Significant potential with market adoption',
    blockchainEnabled: true,
    dataFields: ['Coin/Token', 'Blockchain', 'Wallet Address', 'Acquisition Cost', 'Staking Status']
  },
  {
    id: 'derivatives',
    ...
    blockchainEnabled: true,
    dataFields: ['Derivative Type', 'Underlying Asset', 'Strike Price', 'Expiration Date', 'Counterparty']
  },
  {
    id: 'private_equity',
    ...
    blockchainEnabled: true,
    dataFields: ['Investment Stage', 'Portfolio Company', 'Ownership Stake', 'Valuation', 'Investment Date']
  },
  {
    id: 'forex',
  ...
  },
  {
    ...
    blockchainEnabled: true,
    dataFields: ['Equipment Type', 'Manufacturer', 'Purchase Date', 'Serial Number', 'Maintenance Schedule']
  },
  {
    id: 'vehicles',
  ...
  },
  {
    ...
    blockchainEnabled: true,
    dataFields: ['Asset Type', 'Description', 'Acquisition Date', 'Estimated Value', 'Custom Fields']
  }
];
...
const AssetClassification: React.FC<AssetClassificationProps> = ({ selectedClass, onSelectClass }) => {
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Asset Classification</h3>
      <p className="text-sm text-gray-500 mb-6">
        Select the appropriate asset class to ensure proper classification, data structure, and regulatory compliance.
      </p>
          ...
          >
            <div className="flex items-center mb-2">
              <div className={`p-2 rounded-full mr-3 ${
                selectedClass === assetClass.id ? 'bg-primary-100 text-primary-600' : 'bg-gray-100 text-gray-500'
              }`}>
                {assetClass.icon}
              </div>
