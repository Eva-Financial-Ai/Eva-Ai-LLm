...
const AILifecycleAssistant: React.FC<AILifecycleAssistantProps> = ({ isOpen, onClose, transactionId }) => {
    ...
    const sampleRequests: InfoRequest[] = [
      {
        ...
        description: 'Last 2 years of business financial statements including P&L and balance sheet',
        status: 'pending',
        dueDate: tomorrow,
        createdAt: today,
        followupCount: 2,
  ...
  const scheduleFollowups = () => {
    ...
    const pendingRequests = infoRequests.filter(req => 
  ...
  return (
    ...
    >
      {/* Header */}
      <div className={`${minimized ? 'h-full bg-primary-600' : 'bg-primary-600'} text-white py-3 px-4 flex justify-between items-center`}>
            ...
            <div className="p-4">
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4 rounded-md">
                ...
                <p className="text-sm text-gray-800 mb-3">
                  ...
                  {activeFollowup.status === 'overdue' ? ' overdue' : ' pending'} and requires follow-up
                  to close this deal.
                </p>
              ...
              <div className="space-y-2 mb-4">
                ...
                >
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498.913a1 1 0 01.684.949l.072 1.385a1 1 0 01-.685.949l-1.388.486a1 1 0 00-.65.736L8 14h3l2-2 1 1 1-1v4" />
                    </svg>
                ...
                <button 
                  onClick={() => { setFollowupMode(false); scheduleFollowups(); }}
                ...
                <ul className="space-y-1">
                  {getRoleSuggestions(selectedRole).map((suggestion, index) => (
                    <li key={index} className="text-sm text-blue-800 flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-600 mr-1 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {expandedInfo && (
                          <div className="mt-2 text-xs text-gray-600 border-t border-gray-200 pt-2">
                            ...
                            {request.lastFollowupDate && (
                              <div>Last follow-up: {request.lastFollowupDate.toLocaleDateString()}</div>
                            )}
                          </div>
                        )}
                      </div>
              ...
              <div className="mb-2">
                ...
                <ol className="space-y-2 text-sm">
                  <li className="flex items-start">
                    <span className="bg-primary-100 text-primary-800 w-5 h-5 rounded-full flex items-center justify-center mr-2 flex-shrink-0">1</span>
                    <span>
                      {getRoleNextSteps(selectedRole)}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-gray-100 text-gray-800 w-5 h-5 rounded-full flex items-center justify-center mr-2 flex-shrink-0">2</span>
                    <span>Complete deal structuring and confirm terms with client</span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-gray-100 text-gray-800 w-5 h-5 rounded-full flex items-center justify-center mr-2 flex-shrink-0">3</span>
              ...
              {expandedInfo && (
                <div className="border-t border-gray-200 pt-3 mt-3">
                  ...
                  <ul className="space-y-2 text-xs text-gray-700">
                    <li className="flex">
                      <svg className="h-4 w-4 text-primary-600 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                      <span>Send personalized follow-ups highlighting specific benefits of closing quickly</span>
                    </li>
                    <li className="flex">
                      <svg className="h-4 w-4 text-primary-600 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                      <span>Offer document collection assistance to streamline information gathering</span>
                    </li>
                    <li className="flex">
                      <svg className="h-4 w-4 text-primary-600 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                      <span>Use automatic reminders for all overdue documents to keep deal moving</span>
                    </li>
                  </ul>
                </div>
              )}
