...
import {
  ...
  usePQCryptography,
} from './components/security/PQCryptographyProvider';
...
const DocVerificationSystem = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return <DocumentVerificationSystem isOpen={isOpen} onClose={onClose} />;
};
            ...
            <Router>
              <WorkflowProvider>
                ...
                {(function () {
                  ...
                  const RouterDocVerificationWrapper = ({
                    isOpen,
                    onClose,
                  }: {
                    isOpen: boolean;
                      ...
                      <div className={`app ${theme} text-sm`}>
                        <div className="min-h-screen bg-gray-100">
                          <div className="flex h-screen overflow-hidden">
                            {!sidebarCollapsed && <SideNavigation />}
                            <div
                              ...
                              {showPQCReauth && !isPQCAuthenticated && (
                                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                  <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                                    ...
                                    <p className="mb-4">
                                      Your cryptographic session has expired. Please re-authenticate
                                      to continue.
                                    </p>
