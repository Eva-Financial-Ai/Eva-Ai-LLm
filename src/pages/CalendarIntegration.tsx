...
const CalendarIntegration: React.FC = () => {
  // State management
  const [activeTab, setActiveTab] = useState<'connect' | 'meetings' | 'recordings' | 'schedule'>('connect');
  const [activeProvider, setActiveProvider] = useState<string>('all');
  const [providers, setProviders] = useState<CalendarProvider[]>([
    { id: 'google', name: 'Google Calendar', icon: 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Google_Calendar_icon_%282020%29.svg', connected: false, color: '#4285F4' },
    { id: 'microsoft', name: 'Microsoft 365', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Microsoft_Office_logo_%282019%E2%80%93present%29.svg/1200px-Microsoft_Office_logo_%282019%E2%80%93present%29.svg.png', connected: false, color: '#0078D4' },
    { id: 'apple', name: 'Apple Calendar', icon: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/IcalIcon.png', connected: false, color: '#FF3B30' }
  ]);
    ...
    const mockMeetings: Meeting[] = [
      ...
      },
      {
        ...
        analysis: {
          ...
          actionItems: ['Send contract by Friday', 'Schedule follow-up in 2 weeks', 'Prepare financing proposal']
        }
      }
    ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="p-4 bg-gray-50 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">Link your calendar accounts to manage meetings and schedule events</p>
        </div>
            ...
            .map(meeting => (
              ...
              >
                <div 
                  ...
                  style={{ backgroundColor: providers.find(p => p.id === meeting.provider)?.color || '#CBD5E1' }}
                ></div>
                <div className="flex-1">
                  ...
                  <div className="mt-1 text-sm text-gray-500 flex items-center">
                    ...
                    {meeting.startTime} - {meeting.endTime} ({new Date(meeting.date).toLocaleDateString()})
                  </div>
                  <div className="mt-1 text-sm text-gray-500 flex items-center">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="p-4">
          {meetings
            ...
            .map(meeting => (
              <div key={meeting.id} className="border-b border-gray-100 last:border-0 p-4 hover:bg-gray-50 rounded-md">
                  ...
                  <div className="mt-4 bg-gray-50 rounded-md p-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      <div>
                        ...
                        <p className={`text-sm ${
                          meeting.analysis.sentiment === 'positive' ? 'text-green-600' : 
                          meeting.analysis.sentiment === 'negative' ? 'text-red-600' : 'text-gray-600'
                        }`}>
                          {meeting.analysis.sentiment.charAt(0).toUpperCase() + meeting.analysis.sentiment.slice(1)}
                        </p>
                      </div>
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          {meeting.analysis.keyTopics.map(topic => (
                            <span key={topic} className="text-xs bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">
                              {topic}
                            </span>
                          ))}
                        </div>
        ...
        <div className="p-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-blue-700 mb-4">
              Our AI assistant can help you schedule meetings based on everyone's availability and suggest the best times.
            </p>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="border border-gray-200 rounded p-3 hover:bg-gray-50 cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600">30-minute meeting template for initial client consultations</p>
                </div>
                <div className="border border-gray-200 rounded p-3 hover:bg-gray-50 cursor-pointer">
                ...
                <div className="border border-gray-200 rounded p-3 hover:bg-gray-50 cursor-pointer">
                  ...
                  <p className="text-sm text-gray-600">60-minute comprehensive business review with clients</p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center text-gray-500 mb-4">
              ...
              <span>{new Date(selectedMeeting.date).toLocaleDateString()} ({selectedMeeting.startTime} - {selectedMeeting.endTime})</span>
            </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label htmlFor="meeting-start" className="block text-sm font-medium text-gray-700 mb-1">
                    Start Time
                  </label>
                  <input 
                    type="time"
                ...
                <div>
                  <label htmlFor="meeting-end" className="block text-sm font-medium text-gray-700 mb-1">
                    End Time
                  </label>
                  <input 
                    type="time"
              ...
              <div>
                <label htmlFor="calendar-provider" className="block text-sm font-medium text-gray-700 mb-1">
                  Calendar Provider
                </label>
                <select
