            ...
            <div className="flex flex-col">
              {tabs.map(tab => (
                <button
                  ...
                  } px-3 py-2.5 text-left text-base rounded-md mb-1`}
                >
                  {tab.name}
                </button>
              ))}
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        Manage your business organizations here. You can add multiple businesses and
                        switch between them when using the platform.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {organizations.length === 0 ? (
                  <div className="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Add your first organization to start managing your business portfolio.
                    </p>
                    <button
                      onClick={() => {
                        setCurrentOrganization(null);
              ...
              <div className="p-6">
                ...
                <div className="bg-blue-50 p-4 rounded-md mb-6">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        Manage your customers and prospects here. You can track contact information,
                ...
                {customers.length === 0 ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <select className="px-3 py-1.5 bg-white border border-gray-300 rounded-md shadow-sm text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-gray-500">
                                      To:{' '}
                                      {request.recipientType.charAt(0).toUpperCase() +
                                        request.recipientType.slice(1)}
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="mt-4">
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-500">
                          Fill out the details of your organization. This information will be used
