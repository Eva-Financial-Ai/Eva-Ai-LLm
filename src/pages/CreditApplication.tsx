...
const CreditApplication: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener(
        ...
        handleBusinessTypeChange as EventListener
      );
    };
  }, []);
  ...
  const handleShareApplication = (recipients: any[], message: string, expirationDays: number) => {
    ...
    setShareSuccess(
      `Application shared successfully with ${recipientNames}. They will receive an email with a link to complete the application.`
    );
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        {selectedBorrower && (
          <div className="flex items-center bg-blue-50 px-4 py-2 rounded-md border border-blue-200 text-blue-700 text-sm">
            ...
            Pre-filled with <span className="font-medium ml-1">Existing Business:</span>{' '}
            <span className="font-medium ml-1">{selectedBorrower.businessName}</span>
            <button
          ...
          {!submitted && !showBlockchainTools && (
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 mt-6">
              ...
              <p className="text-sm text-blue-600 mb-4">
                This credit application form will be processed through our secure system and
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                ...
                <p className="mb-4 text-gray-600">
                  Your application has been submitted and is being processed. You can share this
                  application with brokers, originators, or other parties using the "Share
              ...
              {transactionId && <SharedApplicationTracker applicationId={transactionId} />}
            </div>
          )}
        </div>
      </div>
