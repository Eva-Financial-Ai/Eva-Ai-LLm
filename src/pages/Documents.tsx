...
const Documents: React.FC = () => {
  ...
  useEffect(() => {
    console.log("Documents page mounted, currentTransaction:", currentTransaction ? 'exists' : 'null');
  }, [currentTransaction]);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Filelock Drive</h1>
        <p className="mt-1 text-sm text-gray-500">
          Upload and manage your documents in our secure file storage system
        </p>
      </div>
